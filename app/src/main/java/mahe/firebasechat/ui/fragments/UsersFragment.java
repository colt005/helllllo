...
import mahe.firebasechat.core.users.getall.GetUsersContract;
import mahe.firebasechat.core.users.getall.GetUsersPresenter;
import mahe.firebasechat.models.User;
import mahe.firebasechat.ui.activities.ChatActivity;
import mahe.firebasechat.ui.adapters.UserListingRecyclerAdapter;
import mahe.firebasechat.utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener,ItemClickSupport.OnItemLongClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public boolean onItemLongClicked(RecyclerView recyclerView, int position, View v) {
        mUserListingRecyclerAdapter.removeUser(position);
        notify();
        return false;
    }
}
