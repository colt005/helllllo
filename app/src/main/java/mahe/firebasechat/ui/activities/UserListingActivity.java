package mahe.firebasechat.ui.activities;
...
import mahe.firebasechat.core.logout.LogoutContract;
import mahe.firebasechat.core.logout.LogoutPresenter;
import mahe.firebasechat.ui.adapters.UserListingPagerAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_weather:
                //TODO : Weather API
                Intent intent = new Intent(UserListingActivity.this,MainActivity.class);
                UserListingActivity.this.startActivity(intent);
        }
